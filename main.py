...
# Bloque2:se importan algunos paquetes adicionales y se crea la api(un herramienta que agrupará las operaciones):

import datetime
from fastapi import FastAPI
from fastapi import HTTPException
    # Se crea la aplicaci´pn para que entienda que es una api rest
api=FastAPI()
...
#api.pot = actualizar
    ...
    #descorador /método http    
@api.post("/user/auth/")
    #Asociar a un serviio web
